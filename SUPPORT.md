...
- **Bug Reports**: [Open an issue](https://github.com/jeremylongshore/j-rig-binary-eval/issues/new?template=bug_report.md)
- **Feature Requests**: [Open an issue](https://github.com/jeremylongshore/j-rig-binary-eval/issues/new?template=feature_request.md)
- **Discussions**: [GitHub Discussions](https://github.com/jeremylongshore/j-rig-binary-eval/discussions)
...
3. Include version info and reproduction steps
