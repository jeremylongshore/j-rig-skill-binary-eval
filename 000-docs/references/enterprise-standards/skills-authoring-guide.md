<!-- PROVENANCE: Copied from ~/000-projects/nixtla/000-docs/6767-n-DR-GUID-claude-skills-authoring-guide.md on 2026-03-24.
     ...
     CONFLICTS NOTED:
     - allowed-tools delimiter: Examples use comma-delimited format
       (e.g., "Read,Glob,Grep"). AgentSkills.io spec requires space-delimited.
       Enterprise extension — does not contradict, both may be accepted at runtime.
     - compatible-with field: Not mentioned. AgentSkills.io enterprise tier
       requires it. Enterprise additive gap. -->
