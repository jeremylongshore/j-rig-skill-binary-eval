<!-- PROVENANCE: Copied from ~/000-projects/nixtla/000-docs/6767-m-DR-STND-claude-skills-frontmatter-schema.md on 2026-03-24.
     ...
     CONFLICTS NOTED:
     - allowed-tools delimiter: This file documents allowed-tools as "CSV string"
       with comma-delimited syntax. AgentSkills.io spec requires space-delimited.
       Enterprise extension — does not contradict, both may be accepted at runtime.
     - compatible-with field: Not listed in this schema. AgentSkills.io enterprise
       tier includes it as required. Enterprise additive gap.
     - metadata field: Correctly absent from this schema. AgentSkills.io allows it
       but /skill-creator lists it in INVALID_SKILL_FIELDS. -->
