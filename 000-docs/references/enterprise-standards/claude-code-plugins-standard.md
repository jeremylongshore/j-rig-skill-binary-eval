<!-- PROVENANCE: Copied from ~/000-projects/claude-code-plugins/000-docs/6767-a-SPEC-DR-STND-claude-code-plugins-standard.md on 2026-03-24.
     ...
     NOTE: No hard-limit conflicts found. This file covers plugin-level specs
     (plugin.json, marketplace, hooks, commands, agents) which are outside
     the scope of AgentSkills.io SKILL.md frontmatter constraints. -->
