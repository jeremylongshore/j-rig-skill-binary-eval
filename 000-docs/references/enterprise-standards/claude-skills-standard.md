<!-- PROVENANCE: Copied from ~/000-projects/claude-code-plugins/000-docs/6767-b-SPEC-DR-STND-claude-skills-standard.md on 2026-03-24.
     ...
     - allowed-tools delimiter: This file documents comma-delimited CSV format
       (e.g., "Read,Write,Glob,Grep,Edit"). AgentSkills.io spec requires
       space-delimited (e.g., "Read Write Glob Grep Edit"). Enterprise
       extension — does not contradict, both formats may be accepted at runtime.
     - compatible-with field: AgentSkills.io enterprise tier requires
       compatible-with; this file defines tags but not compatible-with.
       Enterprise additive — does not contradict the standard. -->
