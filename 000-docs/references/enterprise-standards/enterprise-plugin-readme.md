<!-- PROVENANCE: Copied from ~/000-projects/nixtla/000-docs/6767-e-OD-REF-enterprise-plugin-readme-standard.md on 2026-03-24.
     ...
     NOTE: No hard-limit conflicts found. This file defines README structure
     and plugin showcase conventions, not SKILL.md frontmatter schema. -->
